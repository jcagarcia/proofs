...
public class VetsCollectionThymeleafController {
    ...
    @ResponseBody
    public ResponseEntity<ConvertedDatatablesData<VetInfo>> datatablesByIdsIn(@RequestParam("ids") List<Long> ids, DatatablesColumns datatablesColumns, GlobalSearch search, DatatablesPageable pageable, @RequestParam("draw") Integer draw) {
