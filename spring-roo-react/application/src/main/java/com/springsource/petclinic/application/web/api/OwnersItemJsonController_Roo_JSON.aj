...
privileged aspect OwnersItemJsonController_Roo_JSON {
    ...
    declare @type: com.springsource.petclinic.application.web.api.OwnersItemJsonController: @RestController;
    
    declare @type: com.springsource.petclinic.application.web.api.OwnersItemJsonController: @RequestMapping(value = "/api/owners/{owner}", name = "OwnersItemJsonController", produces = MediaType.APPLICATION_JSON_VALUE);
