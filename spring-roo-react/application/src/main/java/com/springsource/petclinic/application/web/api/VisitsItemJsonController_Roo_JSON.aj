...
privileged aspect VisitsItemJsonController_Roo_JSON {
    ...
    declare @type: com.springsource.petclinic.application.web.api.VisitsItemJsonController: @RestController;
    
    declare @type: com.springsource.petclinic.application.web.api.VisitsItemJsonController: @RequestMapping(value = "/api/visits/{visit}", name = "VisitsItemJsonController", produces = MediaType.APPLICATION_JSON_VALUE);
