...
public class VetsItemThymeleafController {
    ...
    public ModelAndView showInline(@ModelAttribute Vet vet, Model model) {
        model.addAttribute("vet", vet);
    ...
    public ModelAndView update(@Valid @ModelAttribute Vet vet, BindingResult result, @RequestParam("version") Integer version, @RequestParam(value = "concurrency", required = false, defaultValue = "") String concurrencyControl, Model model) {
