 ...
 */
@Component
public class OwnersCollectionThymeleafLinkFactory implements MethodLinkFactory<OwnersCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<OwnersCollectionThymeleafController> getControllerClass() {
