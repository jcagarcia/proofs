...
@Component
public class VetsCollectionThymeleafLinkFactory implements MethodLinkFactory<VetsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<VetsCollectionThymeleafController> getControllerClass() {
