...
privileged aspect PetsItemJsonController_Roo_JSON {
    ...
    declare @type: com.springsource.petclinic.application.web.api.PetsItemJsonController: @RestController;
    
    declare @type: com.springsource.petclinic.application.web.api.PetsItemJsonController: @RequestMapping(value = "/api/pets/{pet}", name = "PetsItemJsonController", produces = MediaType.APPLICATION_JSON_VALUE);
