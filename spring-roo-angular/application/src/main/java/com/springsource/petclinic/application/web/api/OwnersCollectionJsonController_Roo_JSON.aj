...
import com.springsource.petclinic.application.web.api.OwnersCollectionJsonController;
...
privileged aspect OwnersCollectionJsonController_Roo_JSON {
    ...
    declare @type: OwnersCollectionJsonController: @RequestMapping(value = "/api/owners", name = "OwnersCollectionJsonController", produces = MediaType.APPLICATION_JSON_VALUE);
