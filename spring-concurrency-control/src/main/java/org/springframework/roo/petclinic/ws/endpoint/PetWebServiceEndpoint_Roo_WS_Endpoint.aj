...
privileged aspect PetWebServiceEndpoint_Roo_WS_Endpoint {
     ...
     * @return Page
     */
    public Page<Pet> PetWebServiceEndpoint.findAllByIdsInByListAndGlobalSearchAndPageable(List<Long> ids, GlobalSearch globalSearch, Pageable pageable) {
        return getPetService().findAllByIdsIn(ids, globalSearch, pageable);
    }
