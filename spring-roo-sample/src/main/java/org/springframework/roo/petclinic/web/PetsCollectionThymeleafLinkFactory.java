...
@Component
public class PetsCollectionThymeleafLinkFactory implements MethodLinkFactory<PetsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<PetsCollectionThymeleafController> getControllerClass() {
