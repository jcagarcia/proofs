...
privileged aspect BooksItemJsonController_Roo_JSON {
    ...
    declare @type: io.github.jcagarcia.proof.tests.application.web.BooksItemJsonController: @RestController;
    
    declare @type: io.github.jcagarcia.proof.tests.application.web.BooksItemJsonController: @RequestMapping(value = "/api/books/{book}", name = "BooksItemJsonController", produces = MediaType.APPLICATION_JSON_VALUE);
