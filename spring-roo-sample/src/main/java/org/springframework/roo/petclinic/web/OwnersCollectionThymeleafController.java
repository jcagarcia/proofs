...
@RooThymeleaf
@Controller
@RequestMapping(value = "/owners", name = "OwnersCollectionThymeleafController", produces = MediaType.TEXT_HTML_VALUE)
public class OwnersCollectionThymeleafController {
     ...
     */
    @Autowired
    public OwnersCollectionThymeleafController(OwnerService ownerService, ConversionService conversionService, MessageSource messageSource, ControllerMethodLinkBuilderFactory linkBuilder) {
    ...
    @ResponseBody
    public ResponseEntity<ConvertedDatatablesData<Owner>> datatables(DatatablesColumns datatablesColumns, GlobalSearch search, DatatablesPageable pageable, @RequestParam("draw") Integer draw) {
    ...
    @ResponseBody
    public ResponseEntity<ConvertedDatatablesData<Owner>> datatablesByIdsIn(@RequestParam("ids") List<Long> ids, DatatablesColumns datatablesColumns, GlobalSearch search, DatatablesPageable pageable, @RequestParam("draw") Integer draw) {
    ...
    public ModelAndView create(@Valid @ModelAttribute Owner owner, BindingResult result, Model model) {
        if (result.hasErrors()) {
            populateForm(model);
