...
@Component
public class VetsItemThymeleafLinkFactory implements MethodLinkFactory<VetsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<VetsItemThymeleafController> getControllerClass() {
