...
privileged aspect VetsCollectionJsonController_Roo_JSON {
    ...
    declare @type: com.springsource.petclinic.application.web.api.VetsCollectionJsonController: @RestController;
    
    declare @type: com.springsource.petclinic.application.web.api.VetsCollectionJsonController: @RequestMapping(value = "/api/vets", name = "VetsCollectionJsonController", produces = MediaType.APPLICATION_JSON_VALUE);
