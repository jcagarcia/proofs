...
privileged aspect VetsItemJsonController_Roo_JSON {
    ...
    declare @type: com.springsource.petclinic.application.web.api.VetsItemJsonController: @RestController;
    
    declare @type: com.springsource.petclinic.application.web.api.VetsItemJsonController: @RequestMapping(value = "/api/vets/{vet}", name = "VetsItemJsonController", produces = MediaType.APPLICATION_JSON_VALUE);
