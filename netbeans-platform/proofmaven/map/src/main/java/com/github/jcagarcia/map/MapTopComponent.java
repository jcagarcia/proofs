 ...
 */
package com.github.jcagarcia.map;
 ...
 */
@ConvertAsProperties(
        dtd = "-//com.github.jcagarcia.map//Map//EN",
        autostore = false
)
...
@ActionID(category = "Window", id = "com.github.jcagarcia.map.MapTopComponent")
...
public final class MapTopComponent extends TopComponent {
    ...
    private final static Logger LOG = Logger.getLogger(MapTopComponent.class.getName());
    ...
    public MapTopComponent() {
        ...
        try {
            ...
            shapeLayerProps.put("shapeFile", "com/github/jcagarcia/map/dcwpo-browse.shp");
            shapeLayerProps.put("spatialIndex", "com/github/jcagarcia/map/dcwpo-browse.ssx");
