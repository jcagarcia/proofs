 ...
 */
@Component
public class VisitsItemThymeleafLinkFactory implements MethodLinkFactory<VisitsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<VisitsItemThymeleafController> getControllerClass() {
